...
{
    { "r0"   , "pc", 2, 0, eEncodingUint, eFormatAddressInfo, {  0,  0, LLDB_REGNUM_GENERIC_PC,     0,  0 }, NULL, NULL },
    { "r1"   , "sp", 2, 0, eEncodingUint, eFormatAddressInfo, {  1,  1, LLDB_REGNUM_GENERIC_SP,     1,  1 }, NULL, NULL },
    { "r2"   , "", 2, 0, eEncodingUint, eFormatAddressInfo, {  2,  2, LLDB_INVALID_REGNUM,     2,  2 }, NULL, NULL },
    { "r3"   , "", 2, 0, eEncodingUint, eFormatAddressInfo, {  3,  3, LLDB_INVALID_REGNUM,     3,  3 }, NULL, NULL },
    { "r4"   , "", 2, 0, eEncodingUint, eFormatAddressInfo, {  4,  4, LLDB_INVALID_REGNUM,     4,  4 }, NULL, NULL },
    { "r5"   , "", 2, 0, eEncodingUint, eFormatAddressInfo, {  5,  5, LLDB_INVALID_REGNUM,     5,  5 }, NULL, NULL },
    { "r6"   , "", 2, 0, eEncodingUint, eFormatAddressInfo, {  6,  6, LLDB_INVALID_REGNUM,     6,  6 }, NULL, NULL },
    { "r7"   , "", 2, 0, eEncodingUint, eFormatAddressInfo, {  7,  7, LLDB_INVALID_REGNUM,     7,  7 }, NULL, NULL },
    { "r8"   , "", 2, 0, eEncodingUint, eFormatAddressInfo, {  8,  8, LLDB_INVALID_REGNUM,     8,  8 }, NULL, NULL },
    { "r9"   , "", 2, 0, eEncodingUint, eFormatAddressInfo, {  9,  9, LLDB_INVALID_REGNUM,     9,  9 }, NULL, NULL },
    { "r10"   , "", 2, 0, eEncodingUint, eFormatAddressInfo, { 10, 10, LLDB_INVALID_REGNUM,    10, 10 }, NULL, NULL },
    { "r11"   , "", 2, 0, eEncodingUint, eFormatAddressInfo, { 11, 11, LLDB_INVALID_REGNUM,    11, 11 }, NULL, NULL },
    { "r12"   , "", 2, 0, eEncodingUint, eFormatAddressInfo, { 12, 12, LLDB_INVALID_REGNUM,    12, 12 }, NULL, NULL },
    { "r13"   , "", 2, 0, eEncodingUint, eFormatAddressInfo, { 13, 13, LLDB_INVALID_REGNUM,    13, 13 }, NULL, NULL },
    { "r14"   , "", 2, 0, eEncodingUint, eFormatAddressInfo, { 14, 14, LLDB_INVALID_REGNUM,    14, 14 }, NULL, NULL },
    { "r15"   , "", 2, 0, eEncodingUint, eFormatAddressInfo, { 15, 15, LLDB_INVALID_REGNUM,    15, 15 }, NULL, NULL }
};
...
ABISysV_msp430::GetPluginNameStatic()
{
    static ConstString g_name( "sysv-msp430" );
    return g_name;
}
...
//------------------------------------------------------------------
lldb_private::ConstString
ABISysV_msp430::GetPluginName( void )
{
    return GetPluginNameStatic();
}

uint32_t
ABISysV_msp430::GetPluginVersion( void )
{
    return 1;
}
